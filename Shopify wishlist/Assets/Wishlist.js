...
window.addEventListener('load', (event) => {
  document.querySelector(".wishlist_count").innerHTML = getWishlist().length;
});
...
const setupGrid = async (grid) => {
  ...
  if(getWishlist().length > 0){
    ...
    grid.innerHTML = "<div style='text-align:center'><h4>Wishlist is empty.</h4><br/><span>You don't have any products in the wishlist yet.</span><br/><span> You will find a lot of interesting products on our 'Shop' page.</span><br/><br/><a href='/collections/all'>Return To Shop</a></div><br/>";
  }
